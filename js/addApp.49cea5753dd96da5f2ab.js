...
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./entities */ "./src/api/entities.js");
/* harmony import */ var _doUpdateSource__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./doUpdateSource */ "./src/api/doUpdateSource.js");
...
var removeEmpty = function removeEmpty(obj) {
  Object.keys(obj).forEach(function (key) {
    if (obj[key] && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_5___default()(obj[key]) === 'object') {
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(obj[key])) {
        delete obj[key];
      } else {
        removeEmpty(obj[key]);
      }
...
var doAttachApp = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(values, formApi, authenticationInitialValues, initialValues) {
    var formState, allFormValues, selectedAuthId, authInitialValues, authentication, valuesWithoutAuth, newAddedValues, updatedValues, newAddedAuthValues, updatedAuthValues, filteredValues, sourceId, endpointId, promises, hasModifiedEndpoint, hasModifiedUrl, _urlOrHost, scheme, host, port, path, endPointPort, endpointData, createEndpointData, endpoint, authenticationData, _yield$Promise$all, _yield$Promise$all2, _sourceDataOut, _endpointDataOut, authenticationDataOut, applicationDataOut, authenticationId, promisesSecondRound, authAppData, isAttachingCostManagement, credentials, billing_source, data, errorMessage;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            filteredValues = removeEmpty(_objectSpread(_objectSpread({}, lodash_merge__WEBPACK_IMPORTED_MODULE_10___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_11___default()(newAddedValues), updatedValues)), {}, {
              authentication: _objectSpread({}, lodash_merge__WEBPACK_IMPORTED_MODULE_10___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_11___default()(newAddedAuthValues), updatedAuthValues))
            }));
            _context.prev = 10;
          ...
          case 13:
            ...
            if (filteredValues.source && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(filteredValues.source)) {
              promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_12__["getSourcesApi"])().updateSource(sourceId, filteredValues.source));
            } else {
              promises.push(Promise.resolve(undefined));
            }

            hasModifiedEndpoint = filteredValues.endpoint && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(filteredValues.endpoint);
            hasModifiedUrl = filteredValues.url && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(filteredValues.url);
            ...
            _urlOrHost = Object(_doUpdateSource__WEBPACK_IMPORTED_MODULE_13__["urlOrHost"])(filteredValues), scheme = _urlOrHost.scheme, host = _urlOrHost.host, port = _urlOrHost.port, path = _urlOrHost.path;
            ...
            promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_12__["getSourcesApi"])().updateEndpoint(endpointId, endpointData));
            _context.next = 33;
            break;
          ...
          case 27:
            ...
            _context.next = 31;
            return Object(_entities__WEBPACK_IMPORTED_MODULE_12__["getSourcesApi"])().createEndpoint(createEndpointData);
          ...
          case 36:
            if (filteredValues.authentication && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_9___default()(filteredValues.authentication)) {
              if (selectedAuthId) {
                promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_12__["getSourcesApi"])().updateAuthentication(selectedAuthId, filteredValues.authentication));
              } else if (endpointId) {
                authenticationData = _objectSpread(_objectSpread({}, filteredValues.authentication), {}, {
                  resource_id: endpointId,
                  resource_type: 'Endpoint'
                });
                promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_12__["getSourcesApi"])().createAuthentication(authenticationData));
              }
            } else {
              promises.push(Promise.resolve(undefined));
            }
            ...
            if (filteredValues.application && filteredValues.application.application_type_id) {
              promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_12__["doCreateApplication"])(sourceId, filteredValues.application.application_type_id));
            } else {
              promises.push(Promise.resolve(undefined));
          ...
          case 40:
            ...
            if (applicationDataOut && applicationDataOut.id && authenticationId) {
              ...
              promisesSecondRound.push(Object(_entities__WEBPACK_IMPORTED_MODULE_12__["getSourcesApi"])().createAuthApp(authAppData));
            }
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_filterApps__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/filterApps */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/filterApps.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_filterApps__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_filterApps__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/CloseModal */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/CloseModal.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/LoadingStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/LoadingStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/ErroredStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/ErroredStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/FinishedStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/FinishedStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var _data_driven_forms_pf4_component_mapper_dist_cjs_form_template__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @data-driven-forms/pf4-component-mapper/dist/cjs/form-template */ "./node_modules/@data-driven-forms/pf4-component-mapper/dist/cjs/form-template.js");
/* harmony import */ var _data_driven_forms_pf4_component_mapper_dist_cjs_form_template__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_data_driven_forms_pf4_component_mapper_dist_cjs_form_template__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var _redux_sources_actions__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../redux/sources/actions */ "./src/redux/sources/actions.js");
/* harmony import */ var _utilities_SourcesFormRenderer__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../utilities/SourcesFormRenderer */ "./src/utilities/SourcesFormRenderer.js");
/* harmony import */ var _AddApplicationSchema__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./AddApplicationSchema */ "./src/components/AddApplication/AddApplicationSchema.js");
/* harmony import */ var _WizardBody__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./WizardBody */ "./src/components/AddApplication/WizardBody.js");
/* harmony import */ var _api_entities__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../api/entities */ "./src/api/entities.js");
/* harmony import */ var _hooks_useSource__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../hooks/useSource */ "./src/hooks/useSource.js");
/* harmony import */ var _hooks_useIsLoaded__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../hooks/useIsLoaded */ "./src/hooks/useIsLoaded.js");
/* harmony import */ var _SourcesTable_formatters__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../SourcesTable/formatters */ "./src/components/SourcesTable/formatters.js");
/* harmony import */ var _Routes__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../Routes */ "./src/Routes.js");
/* harmony import */ var _api_doAttachApp__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../../api/doAttachApp */ "./src/api/doAttachApp.js");
/* harmony import */ var _api_checkSourceStatus__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../../api/checkSourceStatus */ "./src/api/checkSourceStatus.js");
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./reducer */ "./src/components/AddApplication/reducer.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Button */ "./node_modules/@patternfly/react-core/dist/js/components/Button/index.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_29__);
...
var onSubmit = function onSubmit(values, formApi, authenticationInitialValues, dispatch, setState, initialValues, intl) {
  ...
  return Object(_api_doAttachApp__WEBPACK_IMPORTED_MODULE_26__["doAttachApp"])(values, formApi, authenticationInitialValues, initialValues, setState, intl).then( /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.mark(function _callee() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            Object(_api_checkSourceStatus__WEBPACK_IMPORTED_MODULE_27__["checkSourceStatus"])(initialValues.source.id);
            _context.next = 3;
            return dispatch(Object(_redux_sources_actions__WEBPACK_IMPORTED_MODULE_17__["loadEntities"])());
...
var FormTemplateWrapper = function FormTemplateWrapper(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_data_driven_forms_pf4_component_mapper_dist_cjs_form_template__WEBPACK_IMPORTED_MODULE_16___default.a, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
...
var AddApplication = function AddApplication() {
  ...
  var loaded = Object(_hooks_useIsLoaded__WEBPACK_IMPORTED_MODULE_23__["useIsLoaded"])();
  ...
  var source = Object(_hooks_useSource__WEBPACK_IMPORTED_MODULE_22__["useSource"])();
  var dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_7__["useDispatch"])();

  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_5__["useReducer"])(_reducer__WEBPACK_IMPORTED_MODULE_28__["default"], _reducer__WEBPACK_IMPORTED_MODULE_28__["initialState"]),
    ...
    if (source) {
      ...
      if (!removeAppAction) {
        if (source.endpoints && source.endpoints[0]) {
          Object(_api_entities__WEBPACK_IMPORTED_MODULE_21__["getSourcesApi"])().listEndpointAuthentications(source.endpoints[0].id).then(function (_ref4) {
            var data = _ref4.data;
            return setState({
              ...
              initialValues: {
                ...
                url: Object(_SourcesTable_formatters__WEBPACK_IMPORTED_MODULE_24__["endpointToUrl"])(source.endpoints[0]),
  ...
  var goToSources = function goToSources() {
    return history.push(_Routes__WEBPACK_IMPORTED_MODULE_25__["routes"].sources.path);
  };

  if ((!appTypesLoaded || !sourceTypesLoaded || !loaded || state.state === 'loading') && state.state !== 'submitting') {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_WizardBody__WEBPACK_IMPORTED_MODULE_20__["default"], {
      goToSources: goToSources,
      step: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_13___default.a, {
        customText: intl.formatMessage({
          id: 'sources.loading',
          defaultMessage: 'Loading, please wait.'
        }),
        cancelTitle: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["FormattedMessage"], {
          id: "sources.cancel",
  ...
  if (state.state === 'submitting') {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_WizardBody__WEBPACK_IMPORTED_MODULE_20__["default"], {
      ...
      step: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_13___default.a, {
        ...
        customText: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["FormattedMessage"], {
  ...
  if (state.state !== 'wizard') {
    var shownStep = state.state === 'finished' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_15___default.a, {
      ...
      secondaryActions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_29__["Button"], {
        variant: "link",
        onClick: onReset
      ...
      returnButtonTitle: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["FormattedMessage"], {
        id: "sources.backToSources",
        defaultMessage: "Back to Sources"
      }),
      successfulMessage: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["FormattedMessage"], {
        id: "sources.successAddApp",
        defaultMessage: "Your application has been successfully added."
      })
    }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_14___default.a, {
      onRetry: onReset,
      onClose: goToSources,
      message: state.error,
      customText: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["FormattedMessage"], {
      ...
      retryText: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_8__["FormattedMessage"], {
        id: "sources.retry",
  ...
  }).filter(_redhat_cloud_services_frontend_components_sources_cjs_filterApps__WEBPACK_IMPORTED_MODULE_11___default.a);
  ...
  var schema = Object(_AddApplicationSchema__WEBPACK_IMPORTED_MODULE_19__["default"])(availableAppTypes, intl, sourceTypes, appTypes, state.authenticationsValues, source, state.values, container.current);
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_12___default.a, {
    ...
    onStay: onStay,
    onExit: goToSources
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_utilities_SourcesFormRenderer__WEBPACK_IMPORTED_MODULE_18__["default"], {
    schema: schema,
    showFormControls: false,
...
/*!***************************************************************!*\
  !*** ./src/components/AddApplication/AddApplicationSchema.js ***!
  \***************************************************************/
/*! exports provided: NoAvailableApplicationDescription, ApplicationSummary, hasAlreadySupportedAuthType, hasMultipleAuthenticationTypes, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_cjs_use_form_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer/dist/cjs/use-form-api */ "./node_modules/@data-driven-forms/react-form-renderer/dist/cjs/use-form-api.js");
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_cjs_use_form_api__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_data_driven_forms_react_form_renderer_dist_cjs_use_form_api__WEBPACK_IMPORTED_MODULE_6__);
...
var innerSetter = function innerSetter(_ref) {
  ...
  if (!selectedAuthentication.startsWith('new-')) {
    ...
    if (modifiedValues && modifiedValues.authentication) {
      var newAuthenticationValues = lodash_merge__WEBPACK_IMPORTED_MODULE_4___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_5___default()(authentication), modifiedValues.authentication);
    ...
    if (modifiedValues && modifiedValues.authentication) {
      formOptions.change('authentication', _objectSpread(_objectSpread({}, modifiedValues.authentication), {}, {
        authtype: authtype
      }));
    } else {
...
var AuthTypeSetter = function AuthTypeSetter(_ref3) {
  ...
  var formOptions = _data_driven_forms_react_form_renderer_dist_cjs_use_form_api__WEBPACK_IMPORTED_MODULE_6___default()();
  var selectedAuthentication = formOptions.getState().values.selectedAuthentication;

  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(selectedAuthentication),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default()(_useState, 2),
      initialValue = _useState2[0],
      setInitialValue = _useState2[1];
...
AuthTypeSetter.propTypes = {
  authenticationValues: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.object),
  modifiedValues: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.object
};
...
var selectAuthenticationStep = function selectAuthenticationStep(_ref7) {
  var intl = _ref7.intl,
      ...
      modifiedValues = _ref7.modifiedValues;
