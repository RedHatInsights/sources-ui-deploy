      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            filteredValues = removeEmpty(_objectSpread({}, lodash_merge__WEBPACK_IMPORTED_MODULE_9___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_10___default()(newAddedValues), updatedValues), {
          ...
          case 16:
            ...
            endpointData = removeEmpty(_objectSpread({}, filteredValues.endpoint, {
              scheme: scheme,
              host: host,
          ...
          case 30:
            promises.push(Promise.resolve(undefined));
            createEndpointData = _objectSpread({}, endpointData, {
              "default": true,
              source_id: sourceId
            });
            _context.next = 34;
          ...
          case 40:
            if (filteredValues.authentication && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_8___default()(filteredValues.authentication)) {
              if (selectedAuthId) {
                ...
                authenticationData = _objectSpread({}, filteredValues.authentication, {
          ...
          case 44:
            ...
            if (isAttachingCostManagement) {
              ...
              data = billing_source ? _objectSpread({}, data, {
...
/* harmony import */ var _RemoveAppModal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./RemoveAppModal */ "./src/components/AddApplication/RemoveAppModal.js");
/* harmony import */ var _ApplicationsList_ApplicationList__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../ApplicationsList/ApplicationList */ "./src/components/ApplicationsList/ApplicationList.js");
...
var AddApplicationDescription = function AddApplicationDescription() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, removingApp.id && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_RemoveAppModal__WEBPACK_IMPORTED_MODULE_7__["default"], {
    app: removingApp,
    ...
    gutter: "md"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_layouts_Grid_index__WEBPACK_IMPORTED_MODULE_6__["GridItem"], {
    md: 2
  ...
  }, source.name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_layouts_Grid_index__WEBPACK_IMPORTED_MODULE_6__["GridItem"], {
    md: 2
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_4__["Text"], {
    component: _patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_4__["TextVariants"].p
  }, sourceType ? sourceType.product_name : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_3__["FormattedMessage"], {
    id: "sources.typeNotFound",
    defaultMessage: "Type not found"
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_layouts_Grid_index__WEBPACK_IMPORTED_MODULE_6__["GridItem"], {
    md: 8
  }, apps.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ApplicationsList_ApplicationList__WEBPACK_IMPORTED_MODULE_8__["default"], {
...
/* harmony import */ var _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer */ "./node_modules/@data-driven-forms/react-form-renderer/dist/esm/index.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Text/Text */ "./node_modules/@patternfly/react-core/dist/js/components/Text/Text.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _patternfly_react_core_dist_js_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Text/TextContent */ "./node_modules/@patternfly/react-core/dist/js/components/Text/TextContent.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _AddApplicationDescription__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./AddApplicationDescription */ "./src/components/AddApplication/AddApplicationDescription.js");
/* harmony import */ var _AuthTypeSetter__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./AuthTypeSetter */ "./src/components/AddApplication/AuthTypeSetter.js");
/* harmony import */ var _AuthTypeCleaner__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./AuthTypeCleaner */ "./src/components/AddApplication/AuthTypeCleaner.js");
...
var selectAuthenticationStep = function selectAuthenticationStep(_ref8) {
  ...
  var fields = [{
    ...
    name: 'authtypesetter',
    Content: _AuthTypeSetter__WEBPACK_IMPORTED_MODULE_10__["AuthTypeSetter"],
    authenticationValues: authenticationValues,
    hideField: true,
    modifiedValues: modifiedValues
  }];
  applicationTypes.forEach(function (app) {
    var supportedAuthType = lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(app, "supported_authentication_types[".concat(sourceType.name, "][0]"), '');

    if (supportedAuthType && hasAlreadySupportedAuthType(authenticationValues, app, sourceType.name)) {
      var supportedAuthTypeName = lodash_get__WEBPACK_IMPORTED_MODULE_8___default()(sourceType, "schema.authentication", {}).find(function (_ref10) {
        var type = _ref10.type;
        return type === supportedAuthType;
      }).name;
      fields.push({
        component: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_3__["componentTypes"].SUB_FORM,
        ...
        fields: [{
          ...
          component: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_3__["componentTypes"].RADIO,
          ...
          isRequired: true,
          validate: [{
            type: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_3__["validatorTypes"].REQUIRED
          }],
          options: [{
            label: intl.formatMessage({
...
var fields = function fields() {
  ...
  if (!source.imported && hasAvailableApps) {
    ...
    applicationTypes.forEach(function (appType) {
      if (appType.supported_source_types.includes(sourceType.name)) {
        authenticationFields.push(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_7__["schemaBuilder"].createSpecificAuthTypeSelection(sourceType, appType, appendEndpoint, false));
      }
    });
    sourceType.schema.authentication.forEach(function (auth) {
      applicationTypes.forEach(function (appType) {
        if (appType.supported_source_types.includes(sourceType.name)) {
          var appAdditionalSteps = _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_7__["schemaBuilder"].getAdditionalSteps(sourceType.name, auth.type, appType.name);

          if (appAdditionalSteps.length > 0) {
            authenticationFields.push.apply(authenticationFields, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_7__["schemaBuilder"].createAdditionalSteps(appAdditionalSteps, sourceType.name, auth.type, hasEndpointStep, auth.fields, appType.name)));
          }
        }
      });
    });
    ...
    if (hasEndpointStep) {
      authenticationFields.push(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_7__["schemaBuilder"].createEndpointStep(sourceType.schema.endpoint, sourceType.name));
    }
  ...
  return {
    fields: [{
      component: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_3__["componentTypes"].WIZARD,
      name: 'wizard',
      title: intl.formatMessage({
      ...
      fields: [{
        ...
        fields: [{
          component: 'description',
          name: 'description',
          Content: _AddApplicationDescription__WEBPACK_IMPORTED_MODULE_9__["default"]
        }, applicationSelection, {
          component: 'description',
          name: 'authtypesetter',
          Content: _AuthTypeCleaner__WEBPACK_IMPORTED_MODULE_11__["AuthTypeCleaner"],
          hideField: true,
          modifiedValues: modifiedValues
        }]
      }, {
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _patternfly_react_icons_dist_js_icons_pencil_alt_icon__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-icons/dist/js/icons/pencil-alt-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/pencil-alt-icon.js");
/* harmony import */ var _patternfly_react_icons_dist_js_icons_pencil_alt_icon__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_icons_dist_js_icons_pencil_alt_icon__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _patternfly_react_core_dist_js_components_Form_FormGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Form/FormGroup */ "./node_modules/@patternfly/react-core/dist/js/components/Form/FormGroup.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Form_FormGroup__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Form_FormGroup__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_cjs_use_field_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer/dist/cjs/use-field-api */ "./node_modules/@data-driven-forms/react-form-renderer/dist/cjs/use-field-api.js");
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_cjs_use_field_api__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_data_driven_forms_react_form_renderer_dist_cjs_use_field_api__WEBPACK_IMPORTED_MODULE_5__);
...
var EditField = function EditField(props) {
  var _useFieldApi = _data_driven_forms_react_form_renderer_dist_cjs_use_field_api__WEBPACK_IMPORTED_MODULE_5___default()(props),
      ...
      type = _useFieldApi.type,
      setEdit = _useFieldApi.setEdit;
  ...
  var isPassword = type === 'password' || input.name.includes('password');
  var emptyText = isPassword ? 'Click to edit' : 'Click to add';
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_components_Form_FormGroup__WEBPACK_IMPORTED_MODULE_4__["FormGroup"], {
    ...
    onClick: setEdit ? function () {
      return setEdit(input.name);
    } : undefined,
    tabIndex: 0,
    ...
    className: "pf-c-form__horizontal-group ins-c-sources__edit-field-group ".concat(setEdit ? 'clickable' : '')
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_3__["TextContent"], {
    className: "ins-c-sources__edit-field-group-text-content ".concat(setEdit ? 'clickable' : '')
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    className: "ins-c-sources__edit-field-value pf-u-mr-sm"
  }, value ? value : setEdit ? emptyText : ''), setEdit && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_icons_dist_js_icons_pencil_alt_icon__WEBPACK_IMPORTED_MODULE_2___default.a, null))));
};
...
EditField.propTypes = {
  ...
  helperText: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.node,
  hideLabel: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool,
  setEdit: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func,
...
/* harmony import */ var _components_EditField_EditField__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/EditField/EditField */ "./src/components/EditField/EditField.js");
...
var SourcesFormRenderer = function SourcesFormRenderer(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_data_driven_forms_react_form_renderer_dist_cjs_form_renderer__WEBPACK_IMPORTED_MODULE_3___default.a, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    componentMapper: _objectSpread({}, _data_driven_forms_pf4_component_mapper_dist_cjs_component_mapper__WEBPACK_IMPORTED_MODULE_8___default.a, {}, _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_9__["mapperExtension"], {
      'edit-field': _components_EditField_EditField__WEBPACK_IMPORTED_MODULE_10__["default"],
