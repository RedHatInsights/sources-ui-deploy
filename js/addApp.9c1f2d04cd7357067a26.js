      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 28:
            ...
            _context.next = 32;
            return Object(_entities__WEBPACK_IMPORTED_MODULE_14__["getSourcesApi"])().createEndpoint(createEndpointData);
          ...
          case 37:
            if (filteredValues.authentication && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_11___default()(filteredValues.authentication)) {
              if (selectedAuthId) {
                promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_14__["getSourcesApi"])().updateAuthentication(selectedAuthId, filteredValues.authentication));
              } else if (endpointId) {
                authenticationData = _objectSpread(_objectSpread({}, filteredValues.authentication), {}, {
                  resource_id: endpointId,
                  resource_type: 'Endpoint'
                });
                promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_14__["getSourcesApi"])().createAuthentication(authenticationData));
              }
            } else {
              promises.push(Promise.resolve(undefined));
            }
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/CloseModal */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/CloseModal.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_CloseModal__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/LoadingStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/LoadingStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/ErroredStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/ErroredStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/FinishedStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/FinishedStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_TimeoutStep__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/TimeoutStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/TimeoutStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_TimeoutStep__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_TimeoutStep__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var _patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Button */ "./node_modules/@patternfly/react-core/dist/js/components/Button/index.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_28___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_28__);
/* harmony import */ var _patternfly_react_core_dist_js_components_Text__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Text */ "./node_modules/@patternfly/react-core/dist/js/components/Text/index.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Text__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Text__WEBPACK_IMPORTED_MODULE_29__);
...
var onSubmit = function onSubmit(values, formApi, authenticationInitialValues, dispatch, setState, initialValues, appTypes) {
  ...
  return Object(_api_doAttachApp__WEBPACK_IMPORTED_MODULE_25__["doAttachApp"])(values, formApi, authenticationInitialValues, initialValues, appTypes).then( /*#__PURE__*/function () {
    var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.mark(function _callee(data) {
...
var AddApplication = function AddApplication() {
  ...
  var removeApp = function removeApp() {
    ...
    return Object(_removeAppSubmit__WEBPACK_IMPORTED_MODULE_30__["default"])({
    ...
    if (source) {
      ...
      if (!removeAppAction) {
        if (source.endpoints && source.endpoints[0]) {
          Object(_api_entities__WEBPACK_IMPORTED_MODULE_20__["getSourcesApi"])().listEndpointAuthentications(source.endpoints[0].id).then(function (_ref5) {
            var data = _ref5.data;
            return setState({
  ...
  if ((!appTypesLoaded || !sourceTypesLoaded || !loaded || state.state === 'loading') && state.state !== 'submitting') {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_WizardBody__WEBPACK_IMPORTED_MODULE_19__["default"], {
      ...
      step: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_LoadingStep__WEBPACK_IMPORTED_MODULE_11___default.a, {
  ...
  if (state.state !== 'wizard') {
    ...
    if (state.state !== 'finished') {
      shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_12___default.a, {
        onRetry: onReset,
        onClose: goToSources,
        ...
        secondaryActions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_patternfly_react_core_dist_js_components_Text__WEBPACK_IMPORTED_MODULE_29__["Text"], {
          component: "a",
          target: "_blank",
      ...
      switch (state.data.availability_status) {
        case 'available':
          shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_FinishedStep__WEBPACK_IMPORTED_MODULE_13___default.a, {
            ...
            onReset: onReset,
            onClose: goToSources,
            secondaryActions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_28__["Button"], {
              variant: "link",
              onClick: onReset
            }, intl.formatMessage({
          ...
          shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_ErroredStep__WEBPACK_IMPORTED_MODULE_12___default.a, {
            ...
            Component: function Component() {
              return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__["Link"], {
                to: Object(_Routes__WEBPACK_IMPORTED_MODULE_24__["replaceRouteId"])(_Routes__WEBPACK_IMPORTED_MODULE_24__["routes"].sourcesEdit.path, source.id)
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_28__["Button"], {
                variant: "primary",
        ...
        default:
          shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources_cjs_TimeoutStep__WEBPACK_IMPORTED_MODULE_14___default.a, {
            returnButtonTitle: intl.formatMessage({
              id: 'sources.backToSources',
              defaultMessage: 'Back to Sources'
            }),
  ...
  var appIds = source.applications.filter(function (_ref6) {
    var isDeleting = _ref6.isDeleting;
    return !isDeleting;
  ...
  var schema = Object(_AddApplicationSchema__WEBPACK_IMPORTED_MODULE_18__["default"])(availableAppTypes, intl, sourceTypes, appTypes, state.authenticationsValues, source, container.current);
...
var AddApplicationDescription = function AddApplicationDescription(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, removingApp.id && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_RemoveAppModal__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    component: _patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_5__["TextVariants"].p,
    id: "add-application-desc-no-app"
  }, intl.formatMessage({
    id: 'sources.noApps',
...
var ApplicationList = function ApplicationList(_ref) {
  ...
  return source.applications.filter(function (app) {
    ...
    }, display_name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_layouts_Grid_GridItem__WEBPACK_IMPORTED_MODULE_8__["GridItem"], {
      md: 8,
      sm: 6,
