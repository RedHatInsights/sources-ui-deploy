...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/schemaBuilder */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/schemaBuilder.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8__);
  ...
  if (!source.imported && hasAvailableApps) {
    ...
    applicationTypes.forEach(function (appType) {
      if (appType.supported_source_types.includes(sourceType.name)) {
        authenticationFields.push(_redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8__["createSpecificAuthTypeSelection"](sourceType, appType, appendEndpoint, false));
      }
    });
    sourceType.schema.authentication.forEach(function (auth) {
      applicationTypes.forEach(function (appType) {
        if (appType.supported_source_types.includes(sourceType.name)) {
          var appAdditionalSteps = _redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8__["getAdditionalSteps"](sourceType.name, auth.type, appType.name);

          if (appAdditionalSteps.length > 0) {
            authenticationFields.push.apply(authenticationFields, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(_redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8__["createAdditionalSteps"](appAdditionalSteps, sourceType.name, auth.type, hasEndpointStep, auth.fields, appType.name)));
          }
        }
      });
    });
    ...
    if (hasEndpointStep) {
      authenticationFields.push(_redhat_cloud_services_frontend_components_sources_cjs_schemaBuilder__WEBPACK_IMPORTED_MODULE_8__["createEndpointStep"](sourceType.schema.endpoint, sourceType.name));
    }
