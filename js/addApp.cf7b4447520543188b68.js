...
/* harmony import */ var _steps_FinishedStep__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./steps/FinishedStep */ "./src/components/AddApplication/steps/FinishedStep.js");
/* harmony import */ var _WizardBody__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./WizardBody */ "./src/components/AddApplication/WizardBody.js");
/* harmony import */ var _api_entities__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../api/entities */ "./src/api/entities.js");
...
/* harmony import */ var _hooks_useIsLoaded__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../hooks/useIsLoaded */ "./src/hooks/useIsLoaded.js");
/* harmony import */ var _SourcesTable_formatters__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../SourcesTable/formatters */ "./src/components/SourcesTable/formatters.js");
/* harmony import */ var _Routes__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../Routes */ "./src/Routes.js");
/* harmony import */ var _api_doAttachApp__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../api/doAttachApp */ "./src/api/doAttachApp.js");
/* harmony import */ var _api_checkSourceStatus__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../api/checkSourceStatus */ "./src/api/checkSourceStatus.js");
/* harmony import */ var _reducer__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./reducer */ "./src/components/AddApplication/reducer.js");
...
var onSubmit = function onSubmit(values, formApi, authenticationInitialValues, dispatch, setState, initialValues, intl) {
  ...
  return Object(_api_doAttachApp__WEBPACK_IMPORTED_MODULE_23__["doAttachApp"])(values, formApi, authenticationInitialValues, initialValues, setState, intl).then( /*#__PURE__*/_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.mark(function _callee() {
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            Object(_api_checkSourceStatus__WEBPACK_IMPORTED_MODULE_24__["checkSourceStatus"])(initialValues.source.id);
            _context.next = 3;
...
var AddApplication = function AddApplication() {
  ...
  var loaded = Object(_hooks_useIsLoaded__WEBPACK_IMPORTED_MODULE_20__["useIsLoaded"])();
  ...
  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_5__["useReducer"])(_reducer__WEBPACK_IMPORTED_MODULE_25__["default"], _reducer__WEBPACK_IMPORTED_MODULE_25__["initialState"]),
    ...
    if (source) {
      ...
      if (!removeAppAction) {
        if (source.endpoints && source.endpoints[0]) {
          Object(_api_entities__WEBPACK_IMPORTED_MODULE_18__["getSourcesApi"])().listEndpointAuthentications(source.endpoints[0].id).then(function (_ref4) {
            var data = _ref4.data;
            return setState({
              ...
              initialValues: {
                ...
                url: Object(_SourcesTable_formatters__WEBPACK_IMPORTED_MODULE_21__["endpointToUrl"])(source.endpoints[0]),
  ...
  var goToSources = function goToSources() {
    return history.push(_Routes__WEBPACK_IMPORTED_MODULE_22__["routes"].sources.path);
  };

  if ((!appTypesLoaded || !sourceTypesLoaded || !loaded || state.state === 'loading') && state.state !== 'submitting') {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_WizardBody__WEBPACK_IMPORTED_MODULE_17__["default"], {
      goToSources: goToSources,
      step: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_11__["LoadingStep"], {
  ...
  if (state.state !== 'wizard') {
    var shownStep = state.state === 'finished' ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_steps_FinishedStep__WEBPACK_IMPORTED_MODULE_16__["default"], {
      onReset: onReset,
      goToSources: goToSources,
      progressStep: state.progressStep,
      progressTexts: state.progressTexts
    }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_11__["ErroredStep"], {
      onRetry: onReset,
      onClose: goToSources,
      message: state.error,
      progressStep: state.progressStep,
