(self["webpackChunksources_ui"] = self["webpackChunksources_ui"] || []).push([["addApplication"],{
...
/* harmony export */   "doAttachApp": () => (/* binding */ doAttachApp)
/* harmony export */ });
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_handleError__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/handleError */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/handleError.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_getApplicationStatus__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/getApplicationStatus */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/getApplicationStatus.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/constants */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/constants.js");
...
/* harmony import */ var _entities__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./entities */ "./src/api/entities.js");
/* harmony import */ var _doUpdateSource__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./doUpdateSource */ "./src/api/doUpdateSource.js");
...
var removeEmpty = function removeEmpty(obj) {
  Object.keys(obj).forEach(function (key) {
    if (obj[key] && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_5___default()(obj[key]) === 'object') {
      if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_10___default()(obj[key])) {
        delete obj[key];
      } else {
        removeEmpty(obj[key]);
      }
...
var doAttachApp = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(values, formApi, authenticationInitialValues, initialValues) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            newAddedValues = (0,deep_object_diff__WEBPACK_IMPORTED_MODULE_6__.addedDiff)(initialValues, valuesWithoutAuth);
            updatedValues = (0,deep_object_diff__WEBPACK_IMPORTED_MODULE_6__.updatedDiff)(initialValues, valuesWithoutAuth);
            newAddedAuthValues = (0,deep_object_diff__WEBPACK_IMPORTED_MODULE_6__.addedDiff)(authInitialValues, authentication);
            updatedAuthValues = (0,deep_object_diff__WEBPACK_IMPORTED_MODULE_6__.updatedDiff)(authInitialValues, authentication);
            filteredValues = removeEmpty(_objectSpread(_objectSpread({}, lodash_merge__WEBPACK_IMPORTED_MODULE_11___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_12___default()(newAddedValues), updatedValues)), {}, {
              authentication: _objectSpread({}, lodash_merge__WEBPACK_IMPORTED_MODULE_11___default()(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_12___default()(newAddedAuthValues), updatedAuthValues))
            }));
            _context.prev = 11;
          ...
          case 14:
            ...
            if (filteredValues.source && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_10___default()(filteredValues.source)) {
              promises.push((0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().updateSource(sourceId, filteredValues.source));
            } else {
              promises.push(Promise.resolve(undefined));
            }

            hasModifiedEndpoint = filteredValues.endpoint && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_10___default()(filteredValues.endpoint);
            hasModifiedUrl = filteredValues.url && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_10___default()(filteredValues.url);

            if (hasModifiedEndpoint || hasModifiedUrl) {
              _urlOrHost = (0,_doUpdateSource__WEBPACK_IMPORTED_MODULE_14__.urlOrHost)(filteredValues), scheme = _urlOrHost.scheme, host = _urlOrHost.host, port = _urlOrHost.port, path = _urlOrHost.path;
              ...
              if (endpointId) {
                promises.push((0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().updateEndpoint(endpointId, endpointData));
              } else {
                createEndpointData = _objectSpread(_objectSpread({}, endpointData), {}, {
                  "default": true,
                  source_id: sourceId
                });
                promises.push((0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().createEndpoint(createEndpointData));
              }
            } else {
              promises.push(Promise.resolve(undefined));
            }
            ...
            if ((_filteredValues$appli = filteredValues.application) !== null && _filteredValues$appli !== void 0 && _filteredValues$appli.application_type_id) {
              ...
              promises.push((0,_entities__WEBPACK_IMPORTED_MODULE_13__.doCreateApplication)(applicationData));
            } else {
              promises.push(Promise.resolve(undefined));
          ...
          case 25:
            ...
            if (!(filteredValues.authentication && !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_10___default()(filteredValues.authentication))) {
              _context.next = 41;
              break;
            }
            ...
            _context.next = 34;
            return (0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().updateAuthentication(selectedAuthId, filteredValues.authentication);
          ...
          case 37:
            ...
            _context.next = 40;
            return (0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().createAuthentication(authenticationData);
          ...
          case 41:
            ...
            _context.next = 47;
            return (0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().createAuthApp(authAppData);
          ...
          case 47:
            ...
            _context.next = 50;
            return (0,_redhat_cloud_services_frontend_components_sources_esm_getApplicationStatus__WEBPACK_IMPORTED_MODULE_8__.checkAppAvailability)(endpointId, undefined, undefined, 'getEndpoint', startDate);
          ...
          case 51:
            ...
            timeout = (0,_redhat_cloud_services_frontend_components_sources_esm_constants__WEBPACK_IMPORTED_MODULE_9__.timeoutedApps)(appTypes).includes(applicationDataOut.application_type_id) ? 10000 : 0;
            _context.next = 55;
            return (0,_redhat_cloud_services_frontend_components_sources_esm_getApplicationStatus__WEBPACK_IMPORTED_MODULE_8__.checkAppAvailability)(applicationDataOut.id, timeout);
          ...
          case 60:
            ...
            _context.next = 66;
            return (0,_entities__WEBPACK_IMPORTED_MODULE_13__.getSourcesApi)().deleteApplication(appId);

          case 66:
            _context.next = 68;
            return (0,_redhat_cloud_services_frontend_components_sources_esm_handleError__WEBPACK_IMPORTED_MODULE_7__.handleError)(_context.t0);
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_CloseModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/CloseModal */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/CloseModal.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_LoadingStep__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/LoadingStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/LoadingStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_ErroredStep__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/ErroredStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/ErroredStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_FinishedStep__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/FinishedStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/FinishedStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_TimeoutStep__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/TimeoutStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/TimeoutStep.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_computeSourceStatus__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/computeSourceStatus */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/computeSourceStatus.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_AmazonFinishedStep__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/AmazonFinishedStep */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/AmazonFinishedStep.js");
/* harmony import */ var _data_driven_forms_pf4_component_mapper_dist_esm_form_template__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @data-driven-forms/pf4-component-mapper/dist/esm/form-template */ "./node_modules/@data-driven-forms/pf4-component-mapper/dist/esm/form-template.js");
...
/* harmony import */ var _patternfly_react_core_dist_esm_components_Button__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Button */ "./node_modules/@patternfly/react-core/dist/esm/components/Button/Button.js");
/* harmony import */ var _patternfly_react_core_dist_esm_components_Text__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Text */ "./node_modules/@patternfly/react-core/dist/esm/components/Text/Text.js");
/* harmony import */ var _removeAppSubmit__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./removeAppSubmit */ "./src/components/AddApplication/removeAppSubmit.js");
/* harmony import */ var deep_object_diff__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! deep-object-diff */ "./node_modules/deep-object-diff/dist/index.js");
/* harmony import */ var deep_object_diff__WEBPACK_IMPORTED_MODULE_31___default = /*#__PURE__*/__webpack_require__.n(deep_object_diff__WEBPACK_IMPORTED_MODULE_31__);
...
var onSubmit = function onSubmit(values, formApi, authenticationInitialValues, dispatch, setState, initialValues, appTypes, setSelectedApp) {
  ...
  return (0,_api_doAttachApp__WEBPACK_IMPORTED_MODULE_27__.doAttachApp)(values, formApi, authenticationInitialValues, initialValues, appTypes).then( /*#__PURE__*/function () {
    var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee(data) {
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              (0,_api_checkSourceStatus__WEBPACK_IMPORTED_MODULE_28__.checkSourceStatus)(initialValues.source.id);
              _context.next = 3;
              return dispatch((0,_redux_sources_actions__WEBPACK_IMPORTED_MODULE_18__.loadEntities)());
...
var FormTemplateWrapper = function FormTemplateWrapper(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_data_driven_forms_pf4_component_mapper_dist_esm_form_template__WEBPACK_IMPORTED_MODULE_17__.default, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
...
var AddApplication = function AddApplication() {
  ...
  var selectedApp = (0,react__WEBPACK_IMPORTED_MODULE_5__.useRef)();
  ...
  var loaded = (0,_hooks_useIsLoaded__WEBPACK_IMPORTED_MODULE_24__.useIsLoaded)();

  var _useSelector = (0,react_redux__WEBPACK_IMPORTED_MODULE_7__.useSelector)(function (_ref3) {
  ...
  var source = (0,_hooks_useSource__WEBPACK_IMPORTED_MODULE_23__.useSource)();
  var dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_7__.useDispatch)();

  var _useReducer = (0,react__WEBPACK_IMPORTED_MODULE_5__.useReducer)(_reducer__WEBPACK_IMPORTED_MODULE_29__.default, _reducer__WEBPACK_IMPORTED_MODULE_29__.initialState),
      _useReducer2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_useReducer, 2),
      state = _useReducer2[0],
      setState = _useReducer2[1];

  var container = (0,react__WEBPACK_IMPORTED_MODULE_5__.useRef)(document.createElement('div'));
  ...
  var removeApp = function removeApp() {
    ...
    return (0,_removeAppSubmit__WEBPACK_IMPORTED_MODULE_30__.default)({
    ...
    if (source) {
      ...
      if (!removeAppAction) {
        if (source.endpoints && source.endpoints[0]) {
          (0,_api_entities__WEBPACK_IMPORTED_MODULE_22__.getSourcesApi)().listEndpointAuthentications(source.endpoints[0].id).then(function (_ref6) {
            var data = _ref6.data;
            return setState({
              ...
              initialValues: {
                ...
                url: (0,_views_formatters__WEBPACK_IMPORTED_MODULE_25__.endpointToUrl)(source.endpoints[0]),
  ...
  var goToSources = function goToSources() {
    return history.push((0,_Routes__WEBPACK_IMPORTED_MODULE_26__.replaceRouteId)(_Routes__WEBPACK_IMPORTED_MODULE_26__.routes.sourcesDetail.path, source.id));
  };
  ...
  if ((!appTypesLoaded || !sourceTypesLoaded || !loaded || state.state === 'loading') && state.state !== 'submitting') {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_WizardBody__WEBPACK_IMPORTED_MODULE_21__.default, {
      goToSources: goToSources,
      title: title,
      description: description,
      step: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_LoadingStep__WEBPACK_IMPORTED_MODULE_11__.default, {
  ...
  if (state.state !== 'wizard') {
    ...
    if (state.state !== 'finished') {
      shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_ErroredStep__WEBPACK_IMPORTED_MODULE_12__.default, {
        onRetry: onReset,
        onClose: goToSources,
        ...
        secondaryActions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_patternfly_react_core_dist_esm_components_Text__WEBPACK_IMPORTED_MODULE_33__.Text, {
          component: "a",
          target: "_blank",
      ...
      switch ((0,_redhat_cloud_services_frontend_components_sources_esm_computeSourceStatus__WEBPACK_IMPORTED_MODULE_15__.default)(state.data)) {
        default:
          if (sourceType.name === 'amazon') {
            shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_AmazonFinishedStep__WEBPACK_IMPORTED_MODULE_16__.default, {
              onClose: goToSources
            });
          } else {
            shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_FinishedStep__WEBPACK_IMPORTED_MODULE_13__.default, {
        ...
        case 'unavailable':
          shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_ErroredStep__WEBPACK_IMPORTED_MODULE_12__.default, {
            ...
            secondaryActions: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_patternfly_react_core_dist_esm_components_Button__WEBPACK_IMPORTED_MODULE_34__.Button, {
              variant: "link",
              onClick: removeApp
            }, intl.formatMessage({
              id: 'wizard.removeApp',
            ...
            Component: function Component() {
              return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__.Link, {
                to: (0,_Routes__WEBPACK_IMPORTED_MODULE_26__.replaceRouteId)(_Routes__WEBPACK_IMPORTED_MODULE_26__.routes.sourcesDetail.path, source.id)
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_patternfly_react_core_dist_esm_components_Button__WEBPACK_IMPORTED_MODULE_34__.Button, {
                variant: "primary",
        ...
        case 'timeout':
          shownStep = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_TimeoutStep__WEBPACK_IMPORTED_MODULE_14__.default, {
            returnButtonTitle: intl.formatMessage({
              id: 'sources.exit',
              defaultMessage: 'Exit'
            }),
  ...
  }).filter(_redhat_cloud_services_frontend_components_sources_esm_filterApps__WEBPACK_IMPORTED_MODULE_9__.default).map(function (type) {
    return {
      value: type.id,
  ...
  if (!applicationType || source.applications.find(function (_ref7) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_6__.Redirect, {
      to: (0,_Routes__WEBPACK_IMPORTED_MODULE_26__.replaceRouteId)(_Routes__WEBPACK_IMPORTED_MODULE_26__.routes.sourcesDetail.path, source.id)
    });
  }

  var schema = (0,_AddApplicationSchema__WEBPACK_IMPORTED_MODULE_20__.default)(intl, sourceType, applicationType, state.authenticationsValues, source, container.current, title, description, appTypes);
  ...
  var cancelBeforeExit = function cancelBeforeExit(values) {
    ...
    var isChanged = !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_8___default()((0,deep_object_diff__WEBPACK_IMPORTED_MODULE_31__.diff)(initialValues, newValues));
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement((react__WEBPACK_IMPORTED_MODULE_5___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_redhat_cloud_services_frontend_components_sources_esm_CloseModal__WEBPACK_IMPORTED_MODULE_10__.default, {
    title: intl.formatMessage({
    ...
    onStay: onStay,
    onExit: goToSources
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_5___default().createElement(_utilities_SourcesFormRenderer__WEBPACK_IMPORTED_MODULE_19__.default, {
    schema: schema,
    showFormControls: false,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AddApplication);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ApplicationSummary": () => (/* binding */ ApplicationSummary),
/* harmony export */   "hasAlreadySupportedAuthType": () => (/* binding */ hasAlreadySupportedAuthType),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
/* harmony import */ var _patternfly_react_core_dist_esm_components_Text_Text__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Text/Text */ "./node_modules/@patternfly/react-core/dist/esm/components/Text/Text.js");
/* harmony import */ var _patternfly_react_core_dist_esm_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Text/TextContent */ "./node_modules/@patternfly/react-core/dist/esm/components/Text/TextContent.js");
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/schemaBuilder */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/schemaBuilder.js");
...
/* harmony import */ var _schema_authenticationSelectionStep__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./schema/authenticationSelectionStep */ "./src/components/AddApplication/schema/authenticationSelectionStep.js");
/* harmony import */ var _schema_generateFirstAuthStep__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./schema/generateFirstAuthStep */ "./src/components/AddApplication/schema/generateFirstAuthStep.js");
/* harmony import */ var _schema_selectAuthenticationStep__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./schema/selectAuthenticationStep */ "./src/components/AddApplication/schema/selectAuthenticationStep.js");
...
var ApplicationSummary = function ApplicationSummary() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_patternfly_react_core_dist_esm_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_10__.TextContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(_patternfly_react_core_dist_esm_components_Text_Text__WEBPACK_IMPORTED_MODULE_11__.Text, {
    component: _patternfly_react_core_dist_esm_components_Text_Text__WEBPACK_IMPORTED_MODULE_11__.TextVariants.p
  }, intl.formatMessage({
...
var hasAlreadySupportedAuthType = function hasAlreadySupportedAuthType() {
  ...
  return authValues.find(function (_ref) {
    ...
    return authtype === lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(appType, "supported_authentication_types.".concat(sourceTypeName, "[0]"));
  });
};
...
var fields = function fields(intl, sourceType, appType, authenticationValues, source, container, title, description, applicationTypes) {
  ...
  if (!source.imported) {
    ...
    if (appType.supported_source_types.includes(sourceType.name)) {
      appType.supported_authentication_types[sourceType.name].forEach(function (authtype) {
        authenticationFields.push((0,_schema_generateFirstAuthStep__WEBPACK_IMPORTED_MODULE_7__.default)(sourceType, appType, appendEndpoint, authtype, intl));
      });
    }

    sourceType.schema.authentication.forEach(function (auth) {
      if (appType.supported_source_types.includes(sourceType.name)) {
        var appAdditionalSteps = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_4__.getAdditionalSteps(sourceType.name, auth.type, appType.name);

        if (appAdditionalSteps.length > 0) {
          authenticationFields.push.apply(authenticationFields, _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_4__.createAdditionalSteps(appAdditionalSteps, sourceType.name, auth.type, hasEndpointStep, auth.fields, appType.name)));
        }
      }
    });

    if (hasEndpointStep) {
      authenticationFields.push(_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_4__.createEndpointStep(sourceType.schema.endpoint, sourceType.name));
    }
    ...
    if (hasMultipleAuthTypes) {
      firstStep = (0,_schema_authenticationSelectionStep__WEBPACK_IMPORTED_MODULE_6__.default)(sourceType, appType, intl, authenticationValues);
    }

    hasAlreadyType = hasAlreadySupportedAuthType(authenticationValues, appType, sourceType.name);

    if (hasAlreadyType) {
      firstStep = (0,_schema_selectAuthenticationStep__WEBPACK_IMPORTED_MODULE_8__.default)({
        intl: intl,
        source: source,
  ...
  var appTypeSetter = {
    component: _data_driven_forms_react_form_renderer_dist_esm_component_types__WEBPACK_IMPORTED_MODULE_3__.default.TEXT_FIELD,
  ...
  return {
    fields: [{
      component: _data_driven_forms_react_form_renderer_dist_esm_component_types__WEBPACK_IMPORTED_MODULE_3__.default.WIZARD,
      name: 'wizard',
      title: title,
      inModal: true,
      container: container,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "innerSetter": () => (/* binding */ innerSetter),
/* harmony export */   "AuthTypeSetter": () => (/* binding */ AuthTypeSetter)
/* harmony export */ });
...
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_esm_use_form_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer/dist/esm/use-form-api */ "./node_modules/@data-driven-forms/react-form-renderer/dist/esm/use-form-api.js");
...
var AuthTypeSetter = function AuthTypeSetter(_ref3) {
  ...
  var formOptions = (0,_data_driven_forms_react_form_renderer_dist_esm_use_form_api__WEBPACK_IMPORTED_MODULE_3__.default)();
  var selectedAuthentication = formOptions.getState().values.selectedAuthentication;

  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(selectedAuthentication),
...
AuthTypeSetter.propTypes = {
  authenticationValues: prop_types__WEBPACK_IMPORTED_MODULE_2___default().arrayOf((prop_types__WEBPACK_IMPORTED_MODULE_2___default().object))
};
...
/* harmony import */ var _patternfly_react_core_dist_esm_components_Wizard_Wizard__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Wizard/Wizard */ "./node_modules/@patternfly/react-core/dist/esm/components/Wizard/Wizard.js");
...
var WizardBodyAttach = function WizardBodyAttach(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_patternfly_react_core_dist_esm_components_Wizard_Wizard__WEBPACK_IMPORTED_MODULE_2__.Wizard, {
    isOpen: true,
    onClose: goToSources,
    title: title,
    description: description,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WizardBodyAttach);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_esm_component_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer/dist/esm/component-types */ "./node_modules/@data-driven-forms/react-form-renderer/dist/esm/component-types.js");
/* harmony import */ var _data_driven_forms_react_form_renderer_dist_esm_validator_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer/dist/esm/validator-types */ "./node_modules/@data-driven-forms/react-form-renderer/dist/esm/validator-types.js");
...
var authenticationSelectionStep = function authenticationSelectionStep(sourceType, appType, intl, authenticationValues) {
  ...
  return {
    ...
    fields: [{
      component: _data_driven_forms_react_form_renderer_dist_esm_component_types__WEBPACK_IMPORTED_MODULE_0__.default.RADIO,
      name: 'authtype',
      ...
      isRequired: true,
      validate: [{
        type: _data_driven_forms_react_form_renderer_dist_esm_validator_types__WEBPACK_IMPORTED_MODULE_1__.default.REQUIRED
      }]
    }],
    nextStep: nextStep
  };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (authenticationSelectionStep);
...
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js");
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/esm/schemaBuilder */ "./node_modules/@redhat-cloud-services/frontend-components-sources/esm/schemaBuilder.js");
...
var generateFirstAuthStep = function generateFirstAuthStep(type, appType, endpointFields, authtype, intl) {
  ...
  if (_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.shouldUseAppAuth(type.name, authtype, appType.name)) {
    fields = [];
  }
  ...
  var skipEndpoint = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.shouldSkipEndpoint(type.name, authtype, appType.name);
  var customSteps = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.hasCustomSteps(type.name, authtype, appType.name);
  var nextStep;

  if (_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.getAdditionalSteps(type.name, authtype, appType.name).length > 0) {
  ...
  var additionalIncludesStepKeys = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.getAdditionalStepKeys(type.name, authtype, appType.name);
  var hasCustomStep = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.shouldSkipSelection(type.name, authtype, appType.name);
  var stepProps = {};

  if (hasCustomStep) {
    var firstAdditonalStep = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.getAdditionalSteps(type.name, authtype, appType.name).find(function (_ref2) {
      var name = _ref2.name;
      return !name;
    });
    var additionalFields = _redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.getAdditionalStepFields(auth.fields, additionalStepName);
  ...
  return _objectSpread({
    ...
    fields: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(fields), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.getAdditionalAuthFields(type.name, authtype, appType.name)), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1___default()(_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.injectAuthFieldsInfo(_redhat_cloud_services_frontend_components_sources_esm_schemaBuilder__WEBPACK_IMPORTED_MODULE_2__.getNoStepsFields(auth.fields, additionalIncludesStepKeys), type.name, authtype, appType.name))),
    nextStep: nextStep
  }, stepProps);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (generateFirstAuthStep);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SelectAuthenticationDescription": () => (/* binding */ SelectAuthenticationDescription),
/* harmony export */   "generateAuthSelectionOptions": () => (/* binding */ generateAuthSelectionOptions),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
/* harmony import */ var _patternfly_react_core_dist_esm_components_Text_Text__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Text/Text */ "./node_modules/@patternfly/react-core/dist/esm/components/Text/Text.js");
/* harmony import */ var _patternfly_react_core_dist_esm_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @patternfly/react-core/dist/esm/components/Text/TextContent */ "./node_modules/@patternfly/react-core/dist/esm/components/Text/TextContent.js");
/* harmony import */ var _AuthTypeSetter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../AuthTypeSetter */ "./src/components/AddApplication/AuthTypeSetter.js");
...
var SelectAuthenticationDescription = function SelectAuthenticationDescription(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core_dist_esm_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_8__.TextContent, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_patternfly_react_core_dist_esm_components_Text_Text__WEBPACK_IMPORTED_MODULE_9__.Text, {
    component: _patternfly_react_core_dist_esm_components_Text_Text__WEBPACK_IMPORTED_MODULE_9__.TextVariants.p
  }, intl.formatMessage({
...
SelectAuthenticationDescription.propTypes = {
  applicationTypeName: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string),
  authenticationTypeName: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().string)
};
...
var selectAuthenticationStep = function selectAuthenticationStep(_ref7) {
  ...
  var fields = [{
    component: 'description',
    name: 'authtypesetter',
    Content: _AuthTypeSetter__WEBPACK_IMPORTED_MODULE_6__.AuthTypeSetter,
    authenticationValues: authenticationValues,
    hideField: true
  }];
  ...
  if (ifAppSupported && isAppAvailable) {
    ...
    supportedAuthTypes.forEach(function (supportedAuthType) {
      ...
      if (hasAvailableAuthentications) {
        ...
        fields.push({
          component: _data_driven_forms_react_form_renderer_dist_esm_component_types__WEBPACK_IMPORTED_MODULE_4__.default.SUB_FORM,
          ...
          fields: [{
            ...
            component: _data_driven_forms_react_form_renderer_dist_esm_component_types__WEBPACK_IMPORTED_MODULE_4__.default.RADIO,
            ...
            isRequired: true,
            validate: [{
              type: _data_driven_forms_react_form_renderer_dist_esm_validator_types__WEBPACK_IMPORTED_MODULE_5__.default.REQUIRED
            }],
            options: [{
              label: intl.formatMessage({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (selectAuthenticationStep);

/***/ })

}]);
//# sourceMappingURL=addApplication.8b8589a23d73c4bd5b8e.js.map