...
var ApplicationSelect = function ApplicationSelect(props) {
  ...
  var sourceAppsNames = source.applications.map(function (_ref3) {
    ...
    return (_appTypes$find = appTypes.find(function (_ref4) {
      var id = _ref4.id;
...
var RemoveAppModal = function RemoveAppModal(_ref) {
  ...
  var dependentApps = app.dependent_applications.map(function (appName) {
    ...
    return app.sourceAppsNames.includes(appType === null || appType === void 0 ? void 0 : appType.display_name) && (appType === null || appType === void 0 ? void 0 : appType.display_name);
  }).filter(function (x) {
    return x;
  });
...
/* harmony import */ var _components_AddApplication_ApplicationSelect__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/AddApplication/ApplicationSelect */ "./src/components/AddApplication/ApplicationSelect.js");
...
var SourcesFormRenderer = function SourcesFormRenderer(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_data_driven_forms_react_form_renderer_dist_cjs_form_renderer__WEBPACK_IMPORTED_MODULE_3___default.a, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
    ...
    componentMapper: _objectSpread(_objectSpread(_objectSpread({}, _data_driven_forms_pf4_component_mapper_dist_cjs_component_mapper__WEBPACK_IMPORTED_MODULE_5___default.a), _redhat_cloud_services_frontend_components_sources_cjs_sourceFormRenderer__WEBPACK_IMPORTED_MODULE_6__["mapperExtension"]), {}, {
      ...
      'application-select': _components_AddApplication_ApplicationSelect__WEBPACK_IMPORTED_MODULE_8__["default"]
    })
  }, props));
};
