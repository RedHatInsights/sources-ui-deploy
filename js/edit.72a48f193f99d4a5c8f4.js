...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources */ "./node_modules/@redhat-cloud-services/frontend-components-sources/index.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6__);
...
var getEnhancedCMField = function getEnhancedCMField(sourceType, name, authenticationsTypes) {
  ...
  authenticationsTypes.forEach(function (type) {
    var apps = field ? {} : lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6__["hardcodedSchemas"], [sourceType, 'authentication', type], {});
    Object.keys(apps).find(function (key) {
      var hasAppField = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6__["hardcodedSchemas"], [sourceType, 'authentication', type, key, name], undefined);
...
var getEnhancedAuthField = function getEnhancedAuthField(sourceType, authtype, name) {
  return lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6__["hardcodedSchemas"], [sourceType, 'authentication', authtype, 'generic', name], {});
};
var getAdditionalAuthSteps = function getAdditionalAuthSteps(sourceType, authtype) {
  return lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_6__["hardcodedSchemas"], [sourceType, 'authentication', authtype, 'generic', 'includeStepKeyFields'], []);
};
