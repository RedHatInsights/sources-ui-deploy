...
var AuthenticationManagement = function AuthenticationManagement(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_layouts_Grid__WEBPACK_IMPORTED_MODULE_3__["GridItem"], {
    ...
    authid: auth.id,
    appNames: appNames.length > 0 ? intl.formatMessage({
...
var RemoveAuth = function RemoveAuth(_ref) {
  ...
  if (hasAttachedApp) {
    body = intl.formatMessage({
      ...
      authname: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", {
        key: "b"
      }, schemaAuth.name)
    });
...
/* harmony import */ var _EditField_EditField__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../EditField/EditField */ "./src/components/EditField/EditField.js");




var genericInfo = function genericInfo(sourceId, intl) {
  return [{
    name: 'source.name',
    ...
    originalComponent: _data_driven_forms_react_form_renderer_dist_cjs_component_types__WEBPACK_IMPORTED_MODULE_0___default.a.TEXT_FIELD,
    component: _EditField_EditField__WEBPACK_IMPORTED_MODULE_3__["EDIT_FIELD_NAME"],
...
/*!*********************************************************************!*\
  !*** ./src/components/SourceEditForm/parser/unsupportedAuthType.js ***!
  \*********************************************************************/
/*! exports provided: Content, unsupportedAuthTypeField */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Content = function Content(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_4__["TextContent"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_3__["Text"], {
    component: _patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_3__["TextVariants"].p
  }, intl.formatMessage({
...
var unsupportedAuthTypeField = function unsupportedAuthTypeField(authtype) {
  return {
    component: 'description',
    name: "".concat(authtype, "-unsupported"),
    authtype: authtype,
    Content: Content
  };
};
