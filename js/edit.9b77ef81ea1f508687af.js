...
/* harmony import */ var _parser_application__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./parser/application */ "./src/components/SourceEditForm/parser/application.js");
...
var SourceEditModal = function SourceEditModal() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    if (sourceRedux && initialLoad && appTypesLoaded) {
      ...
      var hasCostManagement = sourceRedux.applications.map(function (_ref2) {
        ...
        var name = _ref3.name;
        return name === _parser_application__WEBPACK_IMPORTED_MODULE_24__["APP_NAMES"].COST_MANAGAMENT;
      })) === null || _appTypes$find === void 0 ? void 0 : _appTypes$find.id);
      Object(_api_doLoadSourceForEdit__WEBPACK_IMPORTED_MODULE_10__["doLoadSourceForEdit"])(sourceRedux, hasCostManagement).then(function (source) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_3__["useEffect"])(function () {
    if (source && appTypesLoaded && sourceTypesLoaded) {
      var _sourceType = sourceTypes.find(function (_ref4) {
        var id = _ref4.id;
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_sourceEditContext__WEBPACK_IMPORTED_MODULE_18__["default"].Provider, {
    ...
    FormTemplate: function FormTemplate(props) {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_ModalFormTemplate__WEBPACK_IMPORTED_MODULE_19__["default"], _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({
        ModalProps: (_ref5 = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_ref5, 'aria-label', intl.formatMessage({
          id: 'sources.editSource',
          defaultMessage: 'Edit source.'
        })), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_ref5, "header", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_Header__WEBPACK_IMPORTED_MODULE_11__["default"], {
          name: source.source.name
        })), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_ref5, "variant", 'large'), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_ref5, "isOpen", !isAuthRemoving), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default()(_ref5, "onClose", returnToSources), _ref5)
      }, props));
    },
    clearedValue: null,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 14:
            ...
            if ((_source$endpoints = source.endpoints) === null || _source$endpoints === void 0 ? void 0 : (_source$endpoints$ = _source$endpoints[0]) === null || _source$endpoints$ === void 0 ? void 0 : _source$endpoints$.id) {
              promises.push(Object(_redhat_cloud_services_frontend_components_sources_cjs_getApplicationStatus__WEBPACK_IMPORTED_MODULE_2__["checkAppAvailability"])(source.endpoints[0].id, undefined, undefined, 'getEndpoint'));
            }
