...
var doLoadSourceForEdit = function doLoadSourceForEdit(source) {
  return Promise.all([Object(_entities__WEBPACK_IMPORTED_MODULE_2__["getSourcesApi"])().showSource(source.id), Object(_entities__WEBPACK_IMPORTED_MODULE_2__["getSourcesApi"])().listSourceEndpoints(source.id), Object(_entities__WEBPACK_IMPORTED_MODULE_2__["getSourcesApi"])().listSourceApplications(source.id), Object(_getCmValues__WEBPACK_IMPORTED_MODULE_3__["getCmValues"])(source.id)["catch"](function () {
    ...
    var basicValues = {
      source: _objectSpread({}, source, {}, sourceData),
      applications: applications.data
    };

    if (costManagement) {
      basicValues = _objectSpread({}, basicValues, {
    ...
    return Object(_entities__WEBPACK_IMPORTED_MODULE_2__["getSourcesApi"])().listEndpointAuthentications(endpoint.id).then(function (authentications) {
      return _objectSpread({}, basicValues, {
...
var SourceEditModal = function SourceEditModal() {
  ...
  var setEdit = function setEdit(name) {
    return setState({
      type: 'setEdit',
      name: name
    });
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_patternfly_react_core_dist_js_components_Modal__WEBPACK_IMPORTED_MODULE_8__["Modal"], {
    ...
    isLarge: true,
    onClose: returnToSources
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_sourceEditContext__WEBPACK_IMPORTED_MODULE_18__["default"].Provider, {
    value: {
      setState: setState,
      source: source
    }
...
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Grid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Grid */ "./node_modules/@patternfly/react-core/dist/js/layouts/Grid/index.js");
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Grid__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_layouts_Grid__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _RemoveAuth__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./RemoveAuth */ "./src/components/SourceEditForm/parser/RemoveAuth.js");
...
var AuthenticationManagement = function AuthenticationManagement(_ref) {
  ...
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(_sourceEditContext__WEBPACK_IMPORTED_MODULE_10__["default"]),
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, isRemoving && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_RemoveAuth__WEBPACK_IMPORTED_MODULE_9__["default"], {
    auth: auth,
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_layouts_Grid__WEBPACK_IMPORTED_MODULE_4__["GridItem"], {
    sm: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_components_Title_Title__WEBPACK_IMPORTED_MODULE_5__["Title"], {
    size: "xl"
  }, schemaAuth.name, "\xA0", !isDeleting && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_components_Button__WEBPACK_IMPORTED_MODULE_3__["Button"], {
    variant: "plain",
    "aria-label": "Remove authentication",
    onClick: function onClick() {
      return setRemove(!isRemoving);
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_icons_dist_js_icons_trash_icon__WEBPACK_IMPORTED_MODULE_8___default.a, null))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_components_Text_TextContent__WEBPACK_IMPORTED_MODULE_6__["TextContent"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_7__["Text"], {
    component: _patternfly_react_core_dist_js_components_Text_Text__WEBPACK_IMPORTED_MODULE_7__["TextVariants"].small,
    className: "pf-u-mb-0"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_11__["FormattedMessage"], {
    id: "sources.removeAuthDescription",
    defaultMessage: "id: {authid} { appNames}",
    values: {
      authid: auth.id,
      appNames: appNames.length > 0 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_11__["FormattedMessage"], {
...
AuthenticationManagement.propTypes = {
  isDeleting: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.bool,
  appTypes: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.object),
  schemaAuth: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.shape({
...
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Split_Split__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Split/Split */ "./node_modules/@patternfly/react-core/dist/js/layouts/Split/Split.js");
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Split_Split__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_layouts_Split_Split__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Split_SplitItem__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Split/SplitItem */ "./node_modules/@patternfly/react-core/dist/js/layouts/Split/SplitItem.js");
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Split_SplitItem__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_layouts_Split_SplitItem__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Stack_Stack__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Stack/Stack */ "./node_modules/@patternfly/react-core/dist/js/layouts/Stack/Stack.js");
/* harmony import */ var _patternfly_react_core_dist_js_layouts_Stack_Stack__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_layouts_Stack_Stack__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var _sourceEditContext__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../sourceEditContext */ "./src/components/SourceEditForm/sourceEditContext.js");
...
/* harmony import */ var _api_entities__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../api/entities */ "./src/api/entities.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources */ "./node_modules/@redhat-cloud-services/frontend-components-sources/index.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_15__);
...
var RemoveAuth = function RemoveAuth(_ref) {
  ...
  var intl = Object(react_intl__WEBPACK_IMPORTED_MODULE_10__["useIntl"])();

  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_0__["useContext"])(_sourceEditContext__WEBPACK_IMPORTED_MODULE_12__["default"]),
  ...
  var onRemove = function onRemove() {
    ...
    onClose();
    return Object(_api_entities__WEBPACK_IMPORTED_MODULE_14__["doDeleteAuthentication"])(auth.id).then(function () {
      setState({
        type: 'removeAuthFulfill',
        authId: auth.id
      });
      dispatch(Object(_redux_sources_actions__WEBPACK_IMPORTED_MODULE_13__["addMessage"])(intl.formatMessage({
      ...
      }), 'danger', Object(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_15__["handleError"])(error)));
    });
  };

  if (hasAttachedApp) {
    body = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_10__["FormattedMessage"], {
      id: "sources.removeAuthWarningApps",
      defaultMessage: "To remove this authentication you have to remove attached {count, plural, one {application} other {applications}}: { appNames }.",
      values: {
        appNames: appNames.join(', '),
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_layouts_Split_Split__WEBPACK_IMPORTED_MODULE_6__["Split"], {
    gutter: "md"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_layouts_Split_SplitItem__WEBPACK_IMPORTED_MODULE_7__["SplitItem"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_icons_dist_js_icons_exclamation_triangle_icon__WEBPACK_IMPORTED_MODULE_9___default.a, {
    size: "xl",
    className: "ins-m-alert ins-c-source__delete-icon"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_layouts_Split_SplitItem__WEBPACK_IMPORTED_MODULE_7__["SplitItem"], {
    isFilled: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_layouts_Stack_Stack__WEBPACK_IMPORTED_MODULE_8__["Stack"], {
    gutter: "md"
...
/* harmony import */ var _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer */ "./node_modules/@data-driven-forms/react-form-renderer/dist/esm/index.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources */ "./node_modules/@redhat-cloud-services/frontend-components-sources/index.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./helpers */ "./src/components/SourceEditForm/parser/helpers.js");
/* harmony import */ var _EditField_EditField__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../EditField/EditField */ "./src/components/EditField/EditField.js");
...
var getEnhancedCMField = function getEnhancedCMField(sourceType, name, authenticationsTypes) {
  ...
  authenticationsTypes.forEach(function (type) {
    var apps = field ? {} : lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__["hardcodedSchemas"], [sourceType, 'authentication', type], {});
    Object.keys(apps).find(function (key) {
      var hasAppField = lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__["hardcodedSchemas"], [sourceType, 'authentication', type, key, name], undefined);
...
var appendClusterIdentifier = function appendClusterIdentifier(editing, setEdit, sourceType) {
  return sourceType.name === 'openshift' ? [_objectSpread({
    name: 'source.source_ref',
    label: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_6__["FormattedMessage"], {
      id: "sources.clusterIdentifier",
      defaultMessage: "Cluster identifier"
    }),
    isRequired: true
  }, editing['source.source_ref'] ? {} : {
    setEdit: setEdit
  }, {
    validate: [{
      type: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__["validatorTypes"].REQUIRED
    }],
    component: editing['source.source_ref'] ? _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__["componentTypes"].TEXT_FIELD : _EditField_EditField__WEBPACK_IMPORTED_MODULE_8__["EDIT_FIELD_NAME"]
  })] : [];
};
var costManagementFields = function costManagementFields() {
  ...
  var editing = arguments.length > 2 ? arguments[2] : undefined;
  var setEdit = arguments.length > 3 ? arguments[3] : undefined;
  var appTypes = arguments.length > 4 ? arguments[4] : undefined;
  ...
  var enhandcedFields = billingSourceFields.map(function (field) {
    return _objectSpread({}, field, {}, getEnhancedCMField(sourceType.name, field.name, authenticationsTypes));
  });
  return {
    component: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__["componentTypes"].SUB_FORM,
    title: costManagementApp.display_name,
    name: costManagementApp.display_name,
    fields: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(Object(_helpers__WEBPACK_IMPORTED_MODULE_7__["modifyFields"])(enhandcedFields, editing, setEdit)), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(appendClusterIdentifier(editing, setEdit, sourceType)))
  };
};
var applicationsFields = function applicationsFields(applications, sourceType, editing, setEdit, appTypes, source) {
  return [costManagementFields(applications, sourceType, editing, setEdit, appTypes, source)];
};
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var react_intl__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-intl */ "./node_modules/react-intl/lib/index.js");
/* harmony import */ var _EditField_EditField__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../EditField/EditField */ "./src/components/EditField/EditField.js");
...
var removeRequiredValidator = function removeRequiredValidator() {
  ...
  return validate.filter(function (validation) {
    return validation.type !== _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__["validatorTypes"].REQUIRED && validation.type !== 'required-validator';
  });
};
var getEnhancedAuthField = function getEnhancedAuthField(sourceType, authtype, name) {
  return lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__["hardcodedSchemas"], [sourceType, 'authentication', authtype, 'generic', name], {});
};
var getAdditionalAuthSteps = function getAdditionalAuthSteps(sourceType, authtype) {
  return lodash_get__WEBPACK_IMPORTED_MODULE_3___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__["hardcodedSchemas"], [sourceType, 'authentication', authtype, 'generic', 'includeStepKeyFields'], []);
};
var modifyAuthSchemas = function modifyAuthSchemas(fields, id, editing, setEdit) {
  return fields.map(function (field) {
    var editedName = field.name.startsWith('authentication') ? createAuthFieldName(field.name, id) : field.name;
    var isEditing = editing[editedName];

    var finalField = _objectSpread({}, field, {
      name: editedName,
      component: isEditing ? field.component : _EditField_EditField__WEBPACK_IMPORTED_MODULE_7__["EDIT_FIELD_NAME"]
    });
    ...
    if (isPassword) {
      finalField.helperText = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_6__["FormattedMessage"], {
...
var authenticationFields = function authenticationFields(authentications, sourceType, editing, setEdit, appTypes) {
  ...
  return authentications.map(function (_ref) {
    ...
    var enhancedFields = schemaAuth.fields.filter(function (field) {
      ...
      return _objectSpread({}, field, {}, getEnhancedAuthField(sourceType.name, auth.authtype, field.name));
    });
    return {
      component: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__["componentTypes"].SUB_FORM,
      name: schemaAuth.name,
...
var getEnhancedEndpointField = function getEnhancedEndpointField(sourceType, name) {
  return lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_5__["hardcodedSchemas"], [sourceType, 'endpoint', name], {});
};
var endpointFields = function endpointFields(sourceType, editing, setEdit) {
  ...
  var enhancedFields = schemaAuth.fields.map(function (field) {
    return _objectSpread({}, field, {}, getEnhancedEndpointField(sourceType.name, field.name));
  });
  return {
    component: _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_4__["componentTypes"].SUB_FORM,
    ...
    name: 'endpoint',
    fields: Object(_helpers__WEBPACK_IMPORTED_MODULE_6__["modifyFields"])(enhancedFields, editing, setEdit)
  };
};
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources */ "./node_modules/@redhat-cloud-services/frontend-components-sources/index.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_4__);
...
/* harmony import */ var _EditField_EditField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../EditField/EditField */ "./src/components/EditField/EditField.js");
...
var genericInfo = function genericInfo(editing, setEdit, sourceId) {
  return [_objectSpread({
    name: 'source.name',
    label: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_2__["FormattedMessage"], {
      id: "sources.sourceName",
      defaultMessage: "Source name"
    }),
    component: editing['source.name'] ? _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_3__["componentTypes"].TEXT_FIELD : _EditField_EditField__WEBPACK_IMPORTED_MODULE_6__["EDIT_FIELD_NAME"]
  }, editing['source.name'] ? {} : {
    setEdit: setEdit
  }, {
    validate: [function (value) {
      return Object(_redhat_cloud_services_frontend_components_sources__WEBPACK_IMPORTED_MODULE_4__["asyncValidator"])(value, sourceId);
    }, {
    ...
    isReadOnly: true,
    component: _EditField_EditField__WEBPACK_IMPORTED_MODULE_6__["EDIT_FIELD_NAME"]
  }];
};
...
/*!*********************************************************!*\
  !*** ./src/components/SourceEditForm/parser/helpers.js ***!
  \*********************************************************/
/*! exports provided: NOT_CHANGING_COMPONENTS, modifyFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @data-driven-forms/react-form-renderer */ "./node_modules/@data-driven-forms/react-form-renderer/dist/esm/index.js");
...
var NOT_CHANGING_COMPONENTS = [_data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_2__["componentTypes"].CHECKBOX, _data_driven_forms_react_form_renderer__WEBPACK_IMPORTED_MODULE_2__["componentTypes"].SWITCH];
var modifyFields = function modifyFields(fields, editing, setEdit) {
  return fields.map(function (field) {
    var isEditing = editing[field.name];

    var finalField = _objectSpread({}, field, {
      component: isEditing || NOT_CHANGING_COMPONENTS.includes(field.component) ? field.component : _EditField_EditField__WEBPACK_IMPORTED_MODULE_1__["EDIT_FIELD_NAME"]
    });
...
var parseSourceToSchema = function parseSourceToSchema(source, editing, setEdit, sourceType, appTypes) {
  return {
    fields: [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(Object(_genericInfo__WEBPACK_IMPORTED_MODULE_1__["genericInfo"])(editing, setEdit, source.source.id)), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(Object(_authentication__WEBPACK_IMPORTED_MODULE_2__["authenticationFields"])(source.authentications, sourceType, editing, setEdit, appTypes)), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(Object(_application__WEBPACK_IMPORTED_MODULE_4__["applicationsFields"])(source.applications, sourceType, editing, setEdit, appTypes, source)), [source.endpoints && source.endpoints.length > 0 ? Object(_endpoint__WEBPACK_IMPORTED_MODULE_3__["endpointFields"])(sourceType, editing, setEdit) : false]).filter(Boolean)
  };
};
  ...
  switch (type) {
    case 'createForm':
      return _objectSpread({}, state, {
        ...
        schema: Object(_parser_parseSourceToSchema__WEBPACK_IMPORTED_MODULE_1__["parseSourceToSchema"])(state.source, state.editing, setEdit, sourceType, appTypes),
        loading: false
      });

    case 'refreshSchema':
      return _objectSpread({}, state, {
        schema: Object(_parser_parseSourceToSchema__WEBPACK_IMPORTED_MODULE_1__["parseSourceToSchema"])(state.source, state.editing, setEdit, state.sourceType, appTypes)
      });
    ...
    case 'setEdit':
      return _objectSpread({}, state, {
        editing: _objectSpread({}, state.editing, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, name, !state.editing[name]))
      });

    case 'removeAuthPending':
      return _objectSpread({}, state, {
        source: _objectSpread({}, state.source, {
          authentications: state.source.authentications.map(function (auth) {
            return auth.id === authId ? _objectSpread({}, auth, {
              isDeleting: true
            }) : auth;
          })
        })
