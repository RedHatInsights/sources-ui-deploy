...
/* harmony import */ var _patternfly_react_core_dist_js_components_Label_Label__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Label/Label */ "./node_modules/@patternfly/react-core/dist/js/components/Label/Label.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Label_Label__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Label_Label__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _patternfly_react_core_dist_js_components_Popover_Popover__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @patternfly/react-core/dist/js/components/Popover/Popover */ "./node_modules/@patternfly/react-core/dist/js/components/Popover/Popover.js");
/* harmony import */ var _patternfly_react_core_dist_js_components_Popover_Popover__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_patternfly_react_core_dist_js_components_Popover_Popover__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _hooks_useSource__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../hooks/useSource */ "./src/hooks/useSource.js");
...
var ApplicationStatusLabel = function ApplicationStatusLabel(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_components_Popover_Popover__WEBPACK_IMPORTED_MODULE_5__["Popover"], {
    showClose: false,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_patternfly_react_core_dist_js_components_Label_Label__WEBPACK_IMPORTED_MODULE_4__["Label"], {
...
var SourceEditModal = function SourceEditModal() {
  ...
  if (submitError) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_ErroredModal__WEBPACK_IMPORTED_MODULE_16__["default"], {
      onRetry: function onRetry() {
        return Object(_onSubmit__WEBPACK_IMPORTED_MODULE_11__["onSubmit"])(values, editing, dispatch, source, intl, setState, appTypes);
      }
    });
  }
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_utilities_SourcesFormRenderer__WEBPACK_IMPORTED_MODULE_9__["default"], {
    ...
    onSubmit: function onSubmit(values, formApi) {
      return Object(_onSubmit__WEBPACK_IMPORTED_MODULE_11__["onSubmit"])(values, formApi.getState().dirtyFields, dispatch, source, intl, setState, appTypes);
    },
...
/*!**************************************************!*\
  !*** ./src/components/SourceEditForm/helpers.js ***!
  \**************************************************/
/*! exports provided: CHECK_ENDPOINT_COMMAND, selectOnlyEditedValues, prepareInitialValues, hasCostManagement, getEditedApplications, prepareMessages */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getEditedApplications = function getEditedApplications(source, editing, appTypes) {
  var _appTypes$find2;

  var editedApplications = [];
  var editedFields = Object.keys(editing);
  var costId = (_appTypes$find2 = appTypes.find(function (_ref4) {
    var name = _ref4.name;
    return name === _parser_application__WEBPACK_IMPORTED_MODULE_6__["APP_NAMES"].COST_MANAGAMENT;
  })) === null || _appTypes$find2 === void 0 ? void 0 : _appTypes$find2.id;
    ...
    if (editing[key]) {
      ...
      if (key.startsWith('authentications')) {
        source.applications.forEach(function (app) {
          return app.authentications.forEach(function (_ref5) {
            var id = _ref5.id,
                resource_type = _ref5.resource_type;
      ...
      if (key.startsWith('billing_source') || key.startsWith('credentials')) {
        ...
        addIfUnique(editedApplications, (_source$applications$ = source.applications.find(function (_ref6) {
          var application_type_id = _ref6.application_type_id;
          return application_type_id === costId;
        })) === null || _source$applications$ === void 0 ? void 0 : _source$applications$.id);
      }

      if (key.startsWith('url') || key.startsWith('endpoint')) {
        source.applications.forEach(function (app) {
          return app.authentications.forEach(function (_ref7) {
            var resource_type = _ref7.resource_type;
...
var prepareMessages = function prepareMessages(source, intl) {
  ...
  var messages = {};
  source.applications.forEach(function (_ref8) {
    var id = _ref8.id,
        availability_status_error = _ref8.availability_status_error,
        availability_status = _ref8.availability_status;
  ...
  if ((_source$endpoints = source.endpoints) !== null && _source$endpoints !== void 0 && (_source$endpoints$ = _source$endpoints[0]) !== null && _source$endpoints$ !== void 0 && _source$endpoints$.availability_status_error) {
    var applicationsUsingEndpoint = source.applications.map(function (app) {
      return app.authentications.find(function (_ref9) {
        var resource_type = _ref9.resource_type;
...
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_getApplicationStatus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @redhat-cloud-services/frontend-components-sources/cjs/getApplicationStatus */ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/getApplicationStatus.js");
/* harmony import */ var _redhat_cloud_services_frontend_components_sources_cjs_getApplicationStatus__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_redhat_cloud_services_frontend_components_sources_cjs_getApplicationStatus__WEBPACK_IMPORTED_MODULE_3__);
...
var onSubmit = /*#__PURE__*/function () {
  var _ref = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(values, editing, dispatch, source, intl, setState, appTypes) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            ...
            messages = {};
            checkApplications = Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["getEditedApplications"])(source, editing, appTypes);
            promises = [];
            checkApplications.forEach(function (checkInfo) {
              if (checkInfo.includes(_helpers__WEBPACK_IMPORTED_MODULE_4__["CHECK_ENDPOINT_COMMAND"])) {
                promises.push(Object(_redhat_cloud_services_frontend_components_sources_cjs_getApplicationStatus__WEBPACK_IMPORTED_MODULE_3__["checkAppAvailability"])(source.endpoints[0].id, undefined, undefined, 'getEndpoint', startDate).then(function (data) {
                  return _objectSpread(_objectSpread({}, data), {}, {
                    id: checkInfo.replace("".concat(_helpers__WEBPACK_IMPORTED_MODULE_4__["CHECK_ENDPOINT_COMMAND"], "-"), '')
                  });
                }));
              } else {
                promises.push(Object(_redhat_cloud_services_frontend_components_sources_cjs_getApplicationStatus__WEBPACK_IMPORTED_MODULE_3__["checkAppAvailability"])(checkInfo, undefined, undefined, undefined, startDate));
              }
            });
  ...
  return function onSubmit(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
...
var createOneAppFields = function createOneAppFields(appType, sourceType, app) {
  ...
  }), sourceType, appType === null || appType === void 0 ? void 0 : appType.name, app.id)), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()((appType === null || appType === void 0 ? void 0 : appType.name) === APP_NAMES.COST_MANAGAMENT ? appendClusterIdentifier(sourceType) : []));
};
...
/*!****************************************************************!*\
  !*** ./src/components/SourceEditForm/parser/authentication.js ***!
  \****************************************************************/
/*! exports provided: createAuthFieldName, createAuthAppFieldName, getLastPartOfName, removeRequiredValidator, getEnhancedAuthField, getAdditionalAuthSteps, getAdditionalAuthStepsKeys, getAdditionalFields, modifyAuthSchemas, authenticationFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createAuthFieldName", function() { return createAuthFieldName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createAuthAppFieldName", function() { return createAuthAppFieldName; });
...
var createAuthAppFieldName = function createAuthAppFieldName(fieldName, id) {
  return "applications.a".concat(id, ".").concat(fieldName.replace('application.', ''));
};
...
var getAdditionalFields = function getAdditionalFields(auth, stepKey) {
  ...
  return (auth === null || auth === void 0 ? void 0 : (_auth$fields = auth.fields) === null || _auth$fields === void 0 ? void 0 : _auth$fields.filter(function (field) {
    return stepKey && field.stepKey === stepKey;
  })) || [];
};
var modifyAuthSchemas = function modifyAuthSchemas(fields, id, appId) {
  return fields.map(function (field) {
    var editedName = field.name.startsWith('authentication') ? createAuthFieldName(field.name, id) : field.name.startsWith('application') ? createAuthAppFieldName(field.name, appId) : field.name;
...
var authenticationFields = function authenticationFields(authentications, sourceType, appName, appId) {
  ...
  return authentications.map(function (auth) {
    ...
    var enhancedFields = schemaAuth.fields.filter(function (field) {
      return additionalStepsFields.includes(field.name) || !additionalStepsFields.length && !field.stepKey || field.stepKey && additionalStepKeys.includes(field.stepKey);
    }).map(function (field) {
