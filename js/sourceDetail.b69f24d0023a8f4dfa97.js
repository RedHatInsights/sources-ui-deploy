...
var doUpdateSource = function doUpdateSource(source, formData) {
  ...
  if (formData.applications) {
    Object.keys(formData.applications).forEach(function (key) {
      var idWithoutPrefix = key.replace('a', '');
      promises.push(Object(_entities__WEBPACK_IMPORTED_MODULE_2__["getSourcesApi"])().updateApplication(idWithoutPrefix, formData.applications[key]));
    });
  }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return Object(_api_doUpdateSource__WEBPACK_IMPORTED_MODULE_7__["doUpdateSource"])(source, Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["selectOnlyEditedValues"])(values, editing));
