...
var insertEditAction = function insertEditAction(actions, intl, push, isOrgAdmin, disabledProps) {
  return actions.splice(1, 0, _objectSpread({
    ...
    onClick: function onClick(_ev, _i, _ref2) {
      var id = _ref2.id;
      return push(Object(_Routes__WEBPACK_IMPORTED_MODULE_14__["replaceRouteId"])(_Routes__WEBPACK_IMPORTED_MODULE_14__["routes"].sourcesEdit.path, id));
    }
  ...
  return function (rowData) {
    ...
    var actions = [_objectSpread({
      ...
      onClick: function onClick(_ev, _i, _ref3) {
        var id = _ref3.id;
        return push(Object(_Routes__WEBPACK_IMPORTED_MODULE_14__["replaceRouteId"])(_Routes__WEBPACK_IMPORTED_MODULE_14__["routes"].sourceManageApps.path, id));
      }
    }, !isOrgAdmin ? disabledProps : {
      component: 'button'
    }), _objectSpread({
...
var SourceEditModal = /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_2__["lazy"])(function () {
  return Promise.all(/*! import() | edit */[__webpack_require__.e("vendors~addApp~addSource~edit~remove"), __webpack_require__.e("vendors~addApp~addSource~edit"), __webpack_require__.e("vendors~addSource~edit"), __webpack_require__.e("addApp~edit"), __webpack_require__.e("edit")]).then(__webpack_require__.bind(null, /*! ../components/SourceEditForm/SourceEditModal */ "./src/components/SourceEditForm/SourceEditModal.js"));
});
