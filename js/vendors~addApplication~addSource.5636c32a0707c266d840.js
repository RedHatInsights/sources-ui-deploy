...
"use strict";
function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}Object.defineProperty(exports,"__esModule",{value:!0});var e=__webpack_require__(/*! react */ "./node_modules/react/index.js"),t=_interopDefault(e),r=__webpack_require__(/*! @patternfly/react-core/dist/js/components/Button/Button.js */ "./node_modules/@patternfly/react-core/dist/js/components/Button/Button.js"),a=_interopDefault(__webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js")),s=__webpack_require__(/*! react-intl */ "./node_modules/react-intl/lib/index.js"),n=__webpack_require__(/*! @patternfly/react-core/dist/js/components/Alert/Alert.js */ "./node_modules/@patternfly/react-core/dist/js/components/Alert/Alert.js"),o=__webpack_require__(/*! @patternfly/react-core/dist/js/components/Text/Text.js */ "./node_modules/@patternfly/react-core/dist/js/components/Text/Text.js"),c=__webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Grid/Grid.js */ "./node_modules/@patternfly/react-core/dist/js/layouts/Grid/Grid.js"),i=__webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Grid/GridItem.js */ "./node_modules/@patternfly/react-core/dist/js/layouts/Grid/GridItem.js"),l=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyState.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyState.js"),m=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyStateSecondaryActions.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyStateSecondaryActions.js"),u=__webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Bullseye/Bullseye.js */ "./node_modules/@patternfly/react-core/dist/js/layouts/Bullseye/Bullseye.js"),d=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyStateIcon.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyStateIcon.js"),p=__webpack_require__(/*! @patternfly/react-core/dist/js/components/Title/Title.js */ "./node_modules/@patternfly/react-core/dist/js/components/Title/Title.js"),f=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyStateBody.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyStateBody.js"),g=_interopDefault(__webpack_require__(/*! @patternfly/react-icons/dist/js/icons/check-circle-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/check-circle-icon.js")),y=function AwsLink(e){var r=e.href,a=e.children;return t.createElement(t.Fragment,null,t.createElement(g,{className:"pf-u-mr-sm",fill:"var(--pf-global--success-color--100)"}),t.createElement(o.Text,{component:"a",href:r,target:"_blank",rel:"noopener noreferrer"},a))};y.propTypes={href:a.string.isRequired,children:a.node.isRequired};var E=insights.chrome.isBeta()?"beta/":"",h="/".concat(E,"subscriptions"),j="/".concat(E,"insights"),M="/".concat(E,"cost-management"),S=function AmazonFinishedStep(a){var E=a.onClose,S=s.useIntl();return t.createElement(e.Fragment,null,t.createElement(n.Alert,{variant:"info",isInline:!0,title:S.formatMessage({id:"aws.alertTitle",defaultMessage:"Allow 24 hours for full activation"})},S.formatMessage({id:"aws.alertDescription",defaultMessage:"Manage connections for this source at any time in Settings > Sources."})),t.createElement(u.Bullseye,null,t.createElement(l.EmptyState,{variant:l.EmptyStateVariant.full,className:"pf-u-mt-md"},t.createElement(d.EmptyStateIcon,{icon:g,color:"var(--pf-global--success-color--100)",className:"pf-u-mb-0"}),t.createElement(p.Title,{headingLevel:"h2",size:"xl",className:"pf-u-mt-xl"},S.formatMessage({id:"aws.successTitle",defaultMessage:"Amazon Web Services connection established"})),t.createElement(f.EmptyStateBody,null,S.formatMessage({id:"aws.successDescription",defaultMessage:"Discover the benefits of your connection or exit to manage your new source."}),t.createElement(c.Grid,{hasGutter:!0,className:"ins-c-source__aws-grid pf-u-mt-md"},t.createElement(i.GridItem,{md:"6"},t.createElement(y,{href:"https://access.redhat.com/management/cloud"},S.formatMessage({id:"aws.goldImages",defaultMessage:"View enabled AWS Gold images"}))),t.createElement(i.GridItem,{md:"6"},t.createElement(y,{href:h},S.formatMessage({id:"aws.subwtachUsage",defaultMessage:"Subscription Watch usage"}))),t.createElement(i.GridItem,{md:"6"},t.createElement(y,{href:j},S.formatMessage({id:"aws.insights",defaultMessage:"Get started with Red Hat Insights"}))),t.createElement(i.GridItem,{md:"6"},t.createElement(y,{href:M},S.formatMessage({id:"aws.costLink",defaultMessage:"Cost Management reporting"}))))),t.createElement(r.Button,{variant:"primary",onClick:E,className:"pf-u-mt-xl"},S.formatMessage({id:"exit",defaultMessage:"Exit"})),t.createElement(m.EmptyStateSecondaryActions,null,t.createElement(o.Text,{component:"a",href:"https://access.redhat.com/public-cloud/aws",target:"_blank",rel:"noopener noreferrer"},S.formatMessage({id:"aws.learnMore",defaultMessage:"Learn more about this Cloud"}))))))};S.propTypes={onClose:a.func.isRequired},exports.default=S;
...
/***/ "./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/FinishedStep-ef43c1f0.js":
/*!******************************************************************************************************!*\
  !*** ./node_modules/@redhat-cloud-services/frontend-components-sources/cjs/FinishedStep-ef43c1f0.js ***!
  \******************************************************************************************************/
/*! no static exports found */
...
"use strict";
function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}var e=_interopDefault(__webpack_require__(/*! react */ "./node_modules/react/index.js")),t=__webpack_require__(/*! @patternfly/react-core/dist/js/components/Button/Button.js */ "./node_modules/@patternfly/react-core/dist/js/components/Button/Button.js"),r=_interopDefault(__webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js")),s=__webpack_require__(/*! react-intl */ "./node_modules/react-intl/lib/index.js"),n=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyState.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyState.js"),o=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyStateSecondaryActions.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyStateSecondaryActions.js"),a=__webpack_require__(/*! @patternfly/react-core/dist/js/layouts/Bullseye/Bullseye.js */ "./node_modules/@patternfly/react-core/dist/js/layouts/Bullseye/Bullseye.js"),c=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyStateIcon.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyStateIcon.js"),i=__webpack_require__(/*! @patternfly/react-core/dist/js/components/Title/Title.js */ "./node_modules/@patternfly/react-core/dist/js/components/Title/Title.js"),l=__webpack_require__(/*! @patternfly/react-core/dist/js/components/EmptyState/EmptyStateBody.js */ "./node_modules/@patternfly/react-core/dist/js/components/EmptyState/EmptyStateBody.js"),u=_interopDefault(__webpack_require__(/*! @patternfly/react-icons/dist/js/icons/check-circle-icon */ "./node_modules/@patternfly/react-icons/dist/js/icons/check-circle-icon.js")),p=function computeSourcesUrl(){return insights.chrome.isBeta()?"/beta/settings/sources":"/settings/sources"},m=function FinishedStep(r){var s=r.onClose,m=r.successfulMessage,d=r.hideSourcesButton,y=r.returnButtonTitle,f=r.title,E=r.linkText,S=r.secondaryActions;return e.createElement(a.Bullseye,null,e.createElement(n.EmptyState,{variant:n.EmptyStateVariant.full,className:"pf-u-mt-4xl"},e.createElement(c.EmptyStateIcon,{icon:u,color:"var(--pf-global--success-color--100)",className:"pf-u-mb-0"}),e.createElement(i.Title,{headingLevel:"h2",size:"xl",className:"pf-u-mt-xl"},f),e.createElement(l.EmptyStateBody,{className:"ins-c-sources__wizard--step-text"},m),e.createElement(t.Button,{variant:"primary",onClick:s,className:"pf-u-mt-xl"},y),!d&&e.createElement(o.EmptyStateSecondaryActions,null,e.createElement(t.Button,{variant:"link",component:"a",target:"_blank",rel:"noopener noreferrer",href:p()},E)),S&&e.createElement(o.EmptyStateSecondaryActions,null,S)))};m.propTypes={onClose:r.func.isRequired,successfulMessage:r.node.isRequired,hideSourcesButton:r.bool,returnButtonTitle:r.node.isRequired,title:r.node,linkText:r.node,secondaryActions:r.node},m.defaultProps={title:e.createElement(s.FormattedMessage,{id:"wizard.succConfiguration",defaultMessage:"Configuration successful"}),linkText:e.createElement(s.FormattedMessage,{id:"wizard.toSources",defaultMessage:"Take me to sources"})},exports.FinishedStep=m,exports.computeSourcesUrl=p;
