...
/***/ "./node_modules/@patternfly/react-core/dist/js/components/ApplicationLauncher/ApplicationLauncherSeparator.js":
/*!********************************************************************************************************************!*\
  !*** ./node_modules/@patternfly/react-core/dist/js/components/ApplicationLauncher/ApplicationLauncherSeparator.js ***!
  \********************************************************************************************************************/
...
const DropdownSeparator_1 = __webpack_require__(/*! ../Dropdown/DropdownSeparator */ "./node_modules/@patternfly/react-core/dist/js/components/Dropdown/DropdownSeparator.js");
...
const favorites_1 = __webpack_require__(/*! ../../helpers/favorites */ "./node_modules/@patternfly/react-core/dist/js/helpers/favorites.js");
...
class SelectMenuWithRef extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(selectConstants_1.SelectConsumer, null, ({ variant, inputIdPrefix }) => (React.createElement(React.Fragment, null,
            ...
            variant === selectConstants_1.SelectVariant.checkbox && !isCustomContent && React.Children.count(children) > 0 && (React.createElement(helpers_1.FocusTrap, { focusTrapOptions: { clickOutsideDeactivates: true, preventScroll: true } },
...
/***/ "./node_modules/@patternfly/react-core/dist/js/helpers/favorites.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@patternfly/react-core/dist/js/helpers/favorites.js ***!
  \**************************************************************************/
/*! no static exports found */
...
const tslib_1 = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
const React = tslib_1.__importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const ApplicationLauncherSeparator_1 = __webpack_require__(/*! ../components/ApplicationLauncher/ApplicationLauncherSeparator */ "./node_modules/@patternfly/react-core/dist/js/components/ApplicationLauncher/ApplicationLauncherSeparator.js");
const Divider_1 = __webpack_require__(/*! ../components/Divider/Divider */ "./node_modules/@patternfly/react-core/dist/js/components/Divider/Divider.js");
/**
 ...
 */
exports.createRenderableFavorites = (items, isGrouped, favorites, isEnterTriggersArrowDown) => {
    if (isGrouped) {
        const favoriteItems = [];
        items.forEach(group => {
 ...
 * @param {any[]} favorites Array of ids of favorited items
 */
exports.extendItemsWithFavorite = (items, isGrouped, favorites) => {
    if (isGrouped) {
...
/***/ "./node_modules/@patternfly/react-icons/dist/js/icons/cloud-icon.js":
/*!**************************************************************************!*\
  !*** ./node_modules/@patternfly/react-icons/dist/js/icons/cloud-icon.js ***!
  \**************************************************************************/
/*! no static exports found */
...
exports.CloudIcon = __webpack_require__(/*! ../createIcon */ "./node_modules/@patternfly/react-icons/dist/js/createIcon.js").createIcon(exports.CloudIconConfig);
